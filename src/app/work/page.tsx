...
const projects = [
  {
    ...
    title: "project 1",
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt quam voluptatibus molestiae.",
    stack: [
      {
        name: "Html 5",
      },
...
export default function WorkPage() {
  const [project, setProject] = useState<(typeof projects)[0]>(projects[0]);
          ...
          <div className="w-full xl:w-[50%]">
            ...
            >
              ...
              <WorkSliderBtns
                ...
                btnClassName="bg-accent hover:bg-accent-hover text-primary text-[22px] w-[44px] flex justify-center items-center transition-all"
                iconsClassName=""
              />
            </Swiper>
          </div>
